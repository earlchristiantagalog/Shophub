...
// ✅ Fetch order details (product info)
$order_stmt = $conn->prepare("
    SELECT o.order_id, o.total, o.status, o.shipping_method, o.payment_method, oi.product_name, oi.product_image, oi.quantity, oi.price
    FROM orders o
